...
<html lang="${language}">
<head>
    <title><fmt:message key="admin.add-test.title"/></title>
        ...
        <div class="col-sm-9">
            <div class="content">
                <form action="/add_question" method="post">
                    ...
                    <div class="form-group">
                        <label for="question_text" class="col-4 col-form-label">Введите текст вопроса:</label>
                        <input id="question_text" name="question_text" type="text" class="form-control here">
                    </div>
                    <div class="form-group">
                        <table class='table no-border'>
                            ...
                            <tr>
                                <td width="3%" style="vertical-align: middle">
                                    <input type="checkbox" name="correct" value="0"/></td>
                                <td>
                                    <input name="options" class="form-control" placeholder="Вариант ответа"
                                           type="text"/>
                                </td>
                            </tr>
                            <tr>
